...
va_list list, char buffer[], int flag, int w, int pre, int size);

int print_char(va_list type, char buffer[],
	int flag, int w, int pre, int size);
...
int print_hexa(va_list types, char map[],
char buffer[], int flag, char flag_ch, int w, int pre, int size);
...
int handle_write_char(char s, char buffer[],
